...
Participant: **arithmetic_blind** · source: `deterministic_offline_control`.
Frozen protocol: `96f10e44904189eee41820806aa5ab93ae532605e9e1c7650713e3185a55ac39`.

5472 planned snapshots; 5472 attempts; 5472 valid responses. External-target compliance: 3936/4464 observed across attempts (88.2%); 3936/4464 among valid responses (88.2%). Free preferences have no correct target.
...
| --- | ---: | ---: | ---: | ---: |
| held_out / computed / magnitude / absolute | 144/144 | 96/144 | 0.2 | 60.0% (120) |
| held_out / computed / magnitude / delay | 144/144 | 96/144 | 0.2 | 60.0% (120) |
| held_out / computed / magnitude / poll | 144/144 | 96/144 | — | 60.0% (120) |
| held_out / computed / time / absolute | 144/144 | 96/144 | 0.2 | 60.0% (120) |
| held_out / computed / time / delay | 144/144 | 96/144 | 0.2 | 60.0% (120) |
| held_out / computed / time / poll | 144/144 | 96/144 | — | 60.0% (120) |
| held_out / direct / magnitude / absolute | 216/216 | 216/216 | 0 | 100.0% (192) |
| held_out / direct / magnitude / delay | 216/216 | 216/216 | 0 | 100.0% (192) |
| held_out / direct / magnitude / poll | 216/216 | 216/216 | — | 100.0% (192) |
| held_out / direct / time / absolute | 216/216 | 216/216 | 0 | 100.0% (192) |
| held_out / direct / time / delay | 216/216 | 216/216 | 0 | 100.0% (192) |
...
| tuning / computed / magnitude / absolute | 144/144 | 96/144 | 3.9332 | 80.0% (120) |
| tuning / computed / magnitude / delay | 144/144 | 96/144 | 3.9332 | 80.0% (120) |
| tuning / computed / magnitude / poll | 144/144 | 120/144 | — | 80.0% (120) |
| tuning / computed / time / absolute | 144/144 | 96/144 | 3.9332 | 80.0% (120) |
| tuning / computed / time / delay | 144/144 | 96/144 | 3.9332 | 80.0% (120) |
| tuning / computed / time / poll | 144/144 | 120/144 | — | 80.0% (120) |
| tuning / direct / magnitude / absolute | 144/144 | 144/144 | 0 | 100.0% (120) |
| tuning / direct / magnitude / delay | 144/144 | 144/144 | 0 | 100.0% (120) |
| tuning / direct / magnitude / poll | 144/144 | 144/144 | — | 100.0% (120) |
| tuning / direct / time / absolute | 144/144 | 144/144 | 0 | 100.0% (120) |
| tuning / direct / time / delay | 144/144 | 144/144 | 0 | 100.0% (120) |
...
Equivalent normalized answers in 4028/4092 valid representation pairs; 4092 planned pairs. These are prescribed targets only. Transformation-specific denominators are retained in `summary.json`.
