...
Participant: **poll_early** · source: `deterministic_offline_control`.
Frozen protocol: `96f10e44904189eee41820806aa5ab93ae532605e9e1c7650713e3185a55ac39`.

5472 planned snapshots; 5472 attempts; 5472 valid responses. External-target compliance: 4320/4464 observed across attempts (96.8%); 4320/4464 among valid responses (96.8%). Free preferences have no correct target.
...
| --- | ---: | ---: | ---: | ---: |
| held_out / computed / magnitude / absolute | 144/144 | 144/144 | 0 | 100.0% (120) |
| held_out / computed / magnitude / delay | 144/144 | 144/144 | 0 | 100.0% (120) |
| held_out / computed / magnitude / poll | 144/144 | 144/144 | — | 100.0% (120) |
| held_out / computed / time / absolute | 144/144 | 144/144 | 0 | 100.0% (120) |
| held_out / computed / time / delay | 144/144 | 144/144 | 0 | 100.0% (120) |
...
| held_out / direct / time / poll | 216/216 | 168/216 | — | 75.0% (192) |
...
| tuning / computed / magnitude / absolute | 144/144 | 144/144 | 0 | 100.0% (120) |
| tuning / computed / magnitude / delay | 144/144 | 144/144 | 0 | 100.0% (120) |
| tuning / computed / magnitude / poll | 144/144 | 144/144 | — | 100.0% (120) |
| tuning / computed / time / absolute | 144/144 | 144/144 | 0 | 100.0% (120) |
| tuning / computed / time / delay | 144/144 | 144/144 | 0 | 100.0% (120) |
...
| tuning / direct / time / poll | 144/144 | 120/144 | — | 80.0% (120) |
...
| held_out / computed / poll | 144/144 | 2 | -33.3% | -33.3% |
| held_out / direct / absolute | 216/216 | 3 | 0.0% | 0.0% |
| held_out / direct / delay | 216/216 | 3 | 0.0% | 0.0% |
| held_out / direct / poll | 216/216 | 3 | -22.2% | -22.2% |
...
| tuning / computed / poll | 144/144 | 1 | -16.7% | -16.7% |
| tuning / direct / absolute | 144/144 | 1 | 0.0% | 0.0% |
| tuning / direct / delay | 144/144 | 1 | 0.0% | 0.0% |
| tuning / direct / poll | 144/144 | 1 | -16.7% | -16.7% |
