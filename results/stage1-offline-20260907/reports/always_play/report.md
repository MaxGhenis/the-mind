...
Participant: **always_play** · source: `deterministic_offline_control`.
Frozen protocol: `96f10e44904189eee41820806aa5ab93ae532605e9e1c7650713e3185a55ac39`.

5472 planned snapshots; 5472 attempts; 5472 valid responses. External-target compliance: 1728/4464 observed across attempts (38.7%); 1728/4464 among valid responses (38.7%). Free preferences have no correct target.
...
| --- | ---: | ---: | ---: | ---: |
| held_out / computed / magnitude / absolute | 144/144 | 72/144 | 0.2 | 60.0% (120) |
| held_out / computed / magnitude / delay | 144/144 | 72/144 | 0.2 | 60.0% (120) |
| held_out / computed / magnitude / poll | 144/144 | 72/144 | — | 60.0% (120) |
| held_out / computed / time / absolute | 144/144 | 72/144 | 0.2 | 60.0% (120) |
| held_out / computed / time / delay | 144/144 | 72/144 | 0.2 | 60.0% (120) |
| held_out / computed / time / poll | 144/144 | 72/144 | — | 60.0% (120) |
| held_out / direct / magnitude / absolute | 216/216 | 72/216 | 0.2 | 37.5% (192) |
| held_out / direct / magnitude / delay | 216/216 | 72/216 | 0.2 | 37.5% (192) |
| held_out / direct / magnitude / poll | 216/216 | 72/216 | — | 37.5% (192) |
| held_out / direct / time / absolute | 216/216 | 72/216 | 0.2 | 37.5% (192) |
| held_out / direct / time / delay | 216/216 | 72/216 | 0.2 | 37.5% (192) |
| held_out / direct / time / poll | 216/216 | 72/216 | — | 37.5% (192) |
| held_out / free / time / absolute | 144/144 | 0/0 | — | — (0) |
| held_out / free / time / delay | 144/144 | 0/0 | — | — (0) |
| held_out / free / time / poll | 720/720 | 0/0 | — | — (0) |
| held_out / never / magnitude / absolute | 96/96 | 0/96 | — | 0.0% (96) |
| held_out / never / magnitude / delay | 96/96 | 0/96 | — | 0.0% (96) |
| held_out / never / magnitude / poll | 96/96 | 0/96 | — | 0.0% (96) |
| held_out / never / time / absolute | 96/96 | 0/96 | — | 0.0% (96) |
| held_out / never / time / delay | 96/96 | 0/96 | — | 0.0% (96) |
| held_out / never / time / poll | 96/96 | 0/96 | — | 0.0% (96) |
| tuning / computed / magnitude / absolute | 144/144 | 72/144 | 4.1 | 60.0% (120) |
| tuning / computed / magnitude / delay | 144/144 | 72/144 | 4.1 | 60.0% (120) |
| tuning / computed / magnitude / poll | 144/144 | 72/144 | — | 60.0% (120) |
| tuning / computed / time / absolute | 144/144 | 72/144 | 4.1 | 60.0% (120) |
| tuning / computed / time / delay | 144/144 | 72/144 | 4.1 | 60.0% (120) |
| tuning / computed / time / poll | 144/144 | 72/144 | — | 60.0% (120) |
| tuning / direct / magnitude / absolute | 144/144 | 72/144 | 4.1 | 60.0% (120) |
| tuning / direct / magnitude / delay | 144/144 | 72/144 | 4.1 | 60.0% (120) |
| tuning / direct / magnitude / poll | 144/144 | 72/144 | — | 60.0% (120) |
| tuning / direct / time / absolute | 144/144 | 72/144 | 4.1 | 60.0% (120) |
| tuning / direct / time / delay | 144/144 | 72/144 | 4.1 | 60.0% (120) |
| tuning / direct / time / poll | 144/144 | 72/144 | — | 60.0% (120) |
...
Never-due: correct waiting at every scheduled snapshot through the inclusive deadline in 0/144 sets; 144 sets have complete valid evidence; 144 have a false activation. Independent snapshot sets, not observed trajectories or survival probabilities.
...
| ---: | ---: | ---: | ---: | ---: |
| 0 | 100.0% | 100.0% | 100.0% | 12/12 |
| 7.5 | 100.0% | 100.0% | 100.0% | 12/12 |
| 15 | 100.0% | 100.0% | 100.0% | 12/12 |
